...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('roles', models.CharField(choices=[('CEO', 'CEO'), ('Director', 'Director'), ('Manager', 'Project Manager'), ('Tech_lead', 'Tech Lead'), ('Senior_developer', 'Senior Developer'), ('Developer', 'Developer')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('recipient', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='personalmeetings', to='users.profile')),
